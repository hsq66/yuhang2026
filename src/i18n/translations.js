  ...
  zh: {
    ...
    customers: {
      ...
      list: [
        ...
        { name: "广厦房屋", abbr: "GS", logo: "/img/gx00.png" },
        { name: "中建科工", abbr: "中建", logo: "/img/zjkg00.png" },
        { name: "任达集团", abbr: "任达", logo: "/img/rd00.png" },
        { name: "广东君誉新能源装备有限公司", abbr: "君誉", logo: "/img/junyu00.png" },
        { name: "胜狮能源", abbr: "HSCL", logo: "/img/hzss00.png" },
        { name: "广州铁道车辆有限公司", abbr: "广铁", logo: "/img/gt00.png" },
      ],
    },
    culture: {
      sectionTag: "企业文化",
  ...
  en: {
    ...
    customers: {
      ...
      list: [
        ...
        { name: "GS Housing", abbr: "GS", logo: "/img/gx00.png" },
        { name: "CSCEC Steel", abbr: "CSCEC", logo: "/img/zjkg00.png" },
        { name: "Renda Group", abbr: "RENDA", logo: "/img/rd00.png" },
        { name: "Guangdong Junyu New Energy Equipment Co., Ltd.", abbr: "Junyu", logo: "/img/junyu00.png" },
        { name: "HSCL Energy", abbr: "HSCL", logo: "/img/hzss00.png" },
        { name: "Guangzhou Railway Vehicle Co., Ltd.", abbr: "GZ Rail", logo: "/img/gt00.png" },
      ],
    },
    culture: {

...
const HERO_IMAGES = [
  ...
  { src: imgPath("slide4_img2.jpg"), alt: "宇航金属厂区" },
]
          ...
          <div className="relative z-10 pt-24 pb-12 bg-green-800 sm:pt-28 sm:pb-14 md:pt-32 md:pb-16 lg:w-1/2 lg:pt-44 lg:pb-28 xl:pt-52 xl:pb-36">
            ...
            <div className="relative z-20 mx-auto lg:max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="text-center max-w-md mx-auto lg:max-w-lg lg:mx-0 lg:text-left">
                <p className="text-lime-400 text-sm font-semibold tracking-widest uppercase mb-3">{tr.hero.tag}</p>
                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl leading-tight">{heading}</h1>
                <p className="mt-3 text-green-100 sm:mt-4 lg:mt-6 lg:text-lg">{subheading}</p>
      ...
      <Container>
        <div className="lg:flex lg:items-center lg:gap-16">
          ...
          <div className="mt-10 lg:mt-0 lg:w-1/2">
            <img src={imgPath("slide3_img1.jpg")} alt="宇航金属厂区"
      ...
      <div className="bg-gray-50">
        <Container>
          ...
          <div className="mt-8 text-center">
            <SecondaryButton to="/products">{lang === "zh" ? "查看全部" : "View All"}</SecondaryButton>
          </div>
        </Container>
      </div>
